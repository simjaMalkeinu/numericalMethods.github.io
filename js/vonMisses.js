const headTable = () => {
    ...
    $('#table').html(`<table id="data">
                        <tr>
                            ...
                            <th><span>f '(x<i>0</i>)</span></th>
                            <th>
                                <span>x<i>n+1</i> = x<i>n</i> -
                                    <div class="fraction">
                                        <span class="fup">f(x<i>n</i>)</span>
                                        <span class="fdn">f '(x<i>0</i>)</span>
                                    </div>
...
const rowsTable = (sideLeft, sideRigth, data) => {
    ...
    const derivateFun = Number(aux.text());                 //la guardamos en una constante ya que siempre sera igual.
